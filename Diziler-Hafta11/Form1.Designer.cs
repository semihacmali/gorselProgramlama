...
namespace Diziler_Hafta11
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.groupBox1.Text = "Haftanın Günleri";
			// 
			// groupBox2
			// 
			...
			this.groupBox2.Size = new System.Drawing.Size(114, 148);
			this.groupBox2.TabIndex = 5;
			this.groupBox2.TabStop = false;
			this.groupBox2.Text = "Sayılar";
			// 
			// label3
			// 
			...
			this.groupBox3.Text = "Rastgele Gün";
			// 
			// label5
			// 
			...
			this.groupBox4.Size = new System.Drawing.Size(209, 242);
			this.groupBox4.TabIndex = 7;
			this.groupBox4.TabStop = false;
			this.groupBox4.Text = "Listeye Eleman Ekleme";
			// 
			// textBox1
			// 
